      ...
      <div className="container">
        <div className="header__wrapper">
          <a href="localhost:3000" className="header__logo">
            <img src={logoB} alt="BOKO - магазин одягу" />
          </a>
          <nav className="header__content-menu">
            <li className="header__nav-item"><a href=" " className="header__nav-link">каталог</a></li>
            <li className="header__nav-item"><a href=" " className="header__nav-link">limited</a></li>
            <li className="header__nav-item"><a href=" " className="header__nav-link">про нас</a></li>
            <li className="header__nav-item"><a href=" " className="header__nav-link">контакти</a></li>
            <li className="header__nav-item"><a href=" " className="header__nav-link">sale</a></li>
            <li className="header__nav-item"><a href=" " className="header__nav-link">look of the day</a></li>
          </nav>
