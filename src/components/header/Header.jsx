    ...
    <header className="header__container">
      <div className="header__wrapper">
        <a href="localhost:3000" className="header__logo">
          <img src={logoHeaderB} alt="Логотип одягу BOKO" className="header__logo-img" />
        </a>
        <nav className="header__nav">
          <div className="header__nav-logo">
            <div className={isOpen ? "navigation-burger active" : "navigation-burger"} onClick={() => handlerMenu()}><span></span></div>
          </div>
          <div className={isOpen ? "header__nav-wrapper active" : "header__nav-wrapper"}>
