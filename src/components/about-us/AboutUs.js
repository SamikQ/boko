            ...
            <div className="container">
                <div className="banner">
                    <div className="banner__description">
                        <div className="banner__page-nav">Home / Про нас</div>
                        <h2 className="banner__title">BOKO’ KYIV</h2>
                        <p className="banner__description-text">
                            Це український бренд заснований в 2010 році Анною
                            Бец та сестрою Анастасією Дзюбою. Натхненний ідеєю
                            створення формату якісного локального шопінгу, бренд
                            став першим таким що для створив українським
                            масмаркетом.
                        </p>
                    </div>
                </div>
                <div className="about-us__information">
                    <div className="about-us__information-left">
                        ...
                        <div className="about-us__information-descr">
