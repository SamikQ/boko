                ...
                <div className="about-us__information">
                    <div className="about-us__information-left">
                        <p className="description__text">
                            ...
                            жіночого гардероба. Бренд має власну лінійку взуття
                            та аксесуарів та регулярно випускає
                    ...
                    <div className="about-us__information-right">
                        <p className="description__text">
                            ...
                            найзручнішу локацію для вас. В реалізації дизайнів
                    ...
                    <div className="about-us__information-left">
                        <p className="description__text">
                            ...
                            made in UA і звички купувати своє. Коли виникла ідея
                            MustHave, нам було по 23 роки: самі одягалися в
                            мас-маркеті і часто натрапляли на дисбаланс
                            ціна-якість, брак моделей і низький рівень сервісу",
                    ...
                    <div className="accordion__items">
                        ...
                        <details class="accordion__item">
                            ...
                            <p class="accordion__body">
                                Yes, we ship your orders to any state and city
                        ...
                        <details class="accordion__item">
                            ...
                            <p class="accordion__body">
                                ...
                                the varieties and help you choose the best
                                option for you.
                            </p>
                        </details>
                        <details class="accordion__item">
