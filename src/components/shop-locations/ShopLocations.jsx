            ...
            <div className="container">
                <div className="wrapper">
                    <div className="shop__locations-header">
                        <h3 className="shop__locations-header__title">наші магазини</h3>
                    </div>
                    <div className="shop__locations-details">
                        <div className="shop__locations-addresses">
                            <ul className="shop__locations-list">
                                <li className="shop__locations-list-item"><img src={logoB} alt="BOKO' lobo black" className="shop__locations-list-logo"/>
                                    <div className="shop__locations-details">
                                        <div className="shop__locations-details-city">
                                            <p>Київ</p>
                                        </div>
                                        <div className="shop__locations-details-address">
                                            <p>Дніпровська набережна,12 ТРЦ River Mall, поверх 2</p>
                                        </div>
                                ...
                                <li className="shop__locations-list-item"><img src={logoB} alt="BOKO' lobo black" className="shop__locations-list-logo"/>
                                    <div className="shop__locations-details">
                                        ...
                                        <div className="shop__locations-details-address">
                                            <p>Південна дорога, 101а, ТРЦ Riviera</p>
                                        </div>
                                        <div className="shop__locations-details-phone">
                        ...
                        <div className="shop__locations-map">
                            <img src={map} alt="point on the map" className="shop__locations-map-pic"/>
                        </div>
                    </div>
                </div>
            </div>
